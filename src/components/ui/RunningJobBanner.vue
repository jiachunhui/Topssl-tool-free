...
<template>
  <div v-if="jobStore.running && route.path !== '/wizard'" class="fixed left-1/2 top-4 z-[95] -translate-x-1/2">
    <button
      class="flex items-center gap-2 rounded-full border border-brand-300 bg-brand-50/95 px-4 py-2 text-sm font-medium text-brand-800 shadow-lg backdrop-blur transition hover:bg-brand-100"
